...
@section('content')
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Add Restaurent</h1>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Add New Restaurent</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 error-placeholder">
                                                ...
                                                <input type="number" class="form-control" name="min"
                                                    placeholder="Enter min cost..." min="1" required>
                                                @error('min')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 error-placeholder">
                                                ...
                                                <input type="number" class="form-control" name="max"
                                                    placeholder="Enter max cost..." min="1" required>
                                                @error('max')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
